...
router.post('/', requireAdmin, (req, res, next) => activityController.create(req, res, next));
...
router.put('/:id', requireAdmin, (req, res, next) => activityController.update(req, res, next));
